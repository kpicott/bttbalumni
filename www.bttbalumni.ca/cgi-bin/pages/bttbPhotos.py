...
class bttbPhotos(bttbPage):
	...
	def title(self): return 'BTTB Alumni Photos'
...
#		html += """
#		<object width="425" height="350"><param name="movie" value="http://www.youtube.com/v/u4x4lAWbYaM"></param><param name="wmode" value="transparent"></param><embed src="http://www.youtube.com/v/u4x4lAWbYaM" type="application/x-shockwave-flash" wmode="transparent" width="425" height="350"></embed></object>
#		"""
		...
		video</span></div>
		<iframe id="videos_list" name="videos_list" src="http://www.youtube.com/videos_list?tag=Burlington Teen Tour Band" scrolling="auto" width="265" height="400" frameborder="0" marginheight="0" marginwidth="0"></iframe> """
		...
		for file, date, info in photos:
			if column == 4:
				html += "</tr><tr>"
				column = 0
			column = column + 1
			html += MapLinks( "<th valign='top' width='100'><a target='photos' href='__PHOTOPATH__/%s.jpg'><img width='100' src='__PHOTOPATH__/%s_Small.jpg'></a>" % (file, file))
			html += "<br>%s" % info
			html += "</th>"
		html += "</tr></table>"
		return html
...
class testPhotos(unittest.TestCase):
	def testDump(self):
		photosPage = bttbPhotos()
		print photosPage.content()
